...
class JASS_ci_vocab
	...
	public:
		...
		void (*method)(JASS::query<uint16_t, 10'000'000, 10> &q);				///< The method to call when that term is seen in the query
	...
	public:
		/*
			...
			------------------------------
		*/
		JASS_ci_vocab(const char *term, void (*method)(JASS::query<uint16_t, 10'000'000, 10> &q)) :
			term(term),
			method(method)
			{
			/* Nothing */
