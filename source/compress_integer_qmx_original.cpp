...
namespace JASS
	...
	*/
	...
	/*
		COMPRESS_INTEGER_QMX_ORIGINAL::ENCODEARRAY()
		--------------------------------------------
	*/
	void compress_integer_qmx_original::encodeArray(const uint32_t *source, uint64_t source_integers, uint32_t *into, uint64_t *nvalue)
		{
		...
		*/
		...
		#endif
		/*
			COMPRESS_INTEGER_QMX_ORIGINAL::DECODEARRAY()
			--------------------------------------------
		...
		*/
		...
		void compress_integer_qmx_original::decodeArray(const uint32_t *source, uint64_t len, uint32_t *to, uint64_t destination_integers)
			{
