...
namespace JASS
	...
	*/
	...
	compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::compress_integer_qmx_original()
		{
		length_buffer = NULL;
	...
	*/
	/*!
		@brief Return the number of bytes necessarty to store the the given integer using variable byte encoding
		@param docno [in] the integer
		@return the number of byyes needed to store the integer
	*/
	...
	*/
	/*!
		@brief Reverse Variable Byte encode the given integer to the given location
		@param dest [in] Where to put the encoding
		@param docno [in] The integer to encode
	*/
	...
	*/
	/*!
		@brief Extract 1 reverse  variable byte encooded integer that ends at the given address
	...
	*/
	static const qmxo_type_and_integers table[] =
		{
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	void compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::write_out(uint8_t **buffer, uint32_t *source, uint32_t raw_count, uint32_t size_in_bits, uint8_t **length_buffer)
		{
		uint32_t current;
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	size_t compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::encode(void *into_as_void, size_t encoded_buffer_length, const document_id::integer *source, size_t source_integers)
		{
		...
		*/
		uint32_t val = (uint32_t)(keys - length_buffer + vbyte_bytes_needed_for((uint32_t)(keys - length_buffer))); // offset (from the end) to the start of the keys
		if (vbyte_bytes_needed_for(val) > vbyte_bytes_needed_for((uint32_t)(keys - length_buffer)))
			val = (uint32_t)(keys - length_buffer + vbyte_bytes_needed_for(val)); 				// although rare, this happens when adding the length of the vbyte encoded length makes the vbyte encoding one byte longer (i.e. 127)
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	void compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::unittest_one(const std::vector<uint32_t> &sequence)
		{
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	void compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::unittest(void)
		{
		/*
		...
		*/
		compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K> compressor;
...
namespace JASS
	{
		...
		*/
		static uint32_t ALIGN_16 qmxo_static_mask_21[]  = {0x1fffff, 0x1fffff, 0x1fffff, 0x1fffff};		///< AND mask for 21-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_12[]  = {0xfff, 0xfff, 0xfff, 0xfff};						///< AND mask for 12-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_10[] = {0x3ff, 0x3ff, 0x3ff, 0x3ff};						///< AND mask for 10-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_9[]  = {0x1ff, 0x1ff, 0x1ff, 0x1ff};						///< AND mask for 9-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_7[]  = {0x7f, 0x7f, 0x7f, 0x7f};							///< AND mask for 7-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_6[]  = {0x3f, 0x3f, 0x3f, 0x3f};							///< AND mask for 6-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_5[]  = {0x1f, 0x1f, 0x1f, 0x1f};							///< AND mask for 5-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_4[]  = {0x0f, 0x0f, 0x0f, 0x0f};							///< AND mask for 4-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_3[]  = {0x07, 0x07, 0x07, 0x07};							///< AND mask for 3-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_2[]  = {0x03, 0x03, 0x03, 0x03};							///< AND mask for 2-bit integers
		static uint32_t ALIGN_16 qmxo_static_mask_1[]  = {0x01, 0x01, 0x01, 0x01};							///< AND mask for 1-bit integers
		template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
		void compress_integer_qmx_original<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::decode(document_id::integer *to, size_t destination_integers, const void *source, size_t len)
			{
			...
			mask_21 = _mm_loadu_si128((__m128i *)qmxo_static_mask_21);
			mask_12 = _mm_loadu_si128((__m128i *)qmxo_static_mask_12);
			mask_10 = _mm_loadu_si128((__m128i *)qmxo_static_mask_10);
			mask_9 = _mm_loadu_si128((__m128i *)qmxo_static_mask_9);
			mask_7 = _mm_loadu_si128((__m128i *)qmxo_static_mask_7);
			mask_6 = _mm_loadu_si128((__m128i *)qmxo_static_mask_6);
			mask_5 = _mm_loadu_si128((__m128i *)qmxo_static_mask_5);
			mask_4 = _mm_loadu_si128((__m128i *)qmxo_static_mask_4);
			mask_3 = _mm_loadu_si128((__m128i *)qmxo_static_mask_3);
			mask_2 = _mm_loadu_si128((__m128i *)qmxo_static_mask_2);
			mask_1 = _mm_loadu_si128((__m128i *)qmxo_static_mask_1);
			...
			while (to < end)
				...
				switch (*keys++)
					...
					case 0x00:
			#ifdef NO_ZEROS
						tmp = _mm_loadu_si128((__m128i *)qmxo_static_mask_1);
			#else
