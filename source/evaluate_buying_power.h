...
namespace JASS
	...
	*/
	/*!
		...
		lowestpriced relevant item and i is allitems in the results list up to the cheapest relevant item).
	*/
	class evaluate_buying_power : evaluate
		...
		public:
			...
			*/
			/*!
				@brief Compute the buying power as found_and_relevant / found.
				...
				no relevant items in the results list.  This metric is akin to Mean Reciprocal Rank.
