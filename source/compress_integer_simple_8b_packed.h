/*
	...
	-----------------------------------
	Copyright (c) 2014-2017 Andrew Trotman, Michael Albert, Blake Burgess
...
/*!
	@file
	@brief Optimally packed Simple-8b Compression.
	@author Blake Burgess, Andrew Trotman, Michael Albert
...
namespace JASS
	{
	/*
		CLASS COMPRESS_INTEGER_SIMPLE_8B_PACKED
		---------------------------------------
	*/
	/*!
		@brief Simple-8b optimally packed into words.
		@details Simple-8b (and other Simple encodings) are normally packed into words
		...
		version of Simple-8b optimally packs integers into words.
	...
	*/
	...
	class compress_integer_simple_8b_packed : public compress_integer<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>
		{
		protected:
		...
		public:
			/*
				COMPRESS_INTEGER_SIMPLE_8B_PACKED::COMPRESS_INTEGER_SIMPLE_8B_PACKED()
				----------------------------------------------------------------------
			*/
			/*!
				@brief Consructor
			*/
			compress_integer_simple_8b_packed()
				{
				blocks_needed = NULL;
				masks = NULL;
				blocks_length = 0;
			...
			*/
			/*!
				@brief Destructor
			*/
			virtual ~compress_integer_simple_8b_packed()
				{
			...
			/*
				COMPRESS_INTEGER_SIMPLE_8B_PACKED::ENCODE()
				-------------------------------------------
			*/
			/*!
			...
			*/
			...
			/*
				COMPRESS_INTEGER_SIMPLE_8B_PACKED::DECODE()
				-------------------------------------------
			*/
			/*!
			...
			*/
			...
			/*
				COMPRESS_INTEGER_SIMPLE_8B_PACKED::UNITTEST()
				---------------------------------------------
			*/
			/*!
