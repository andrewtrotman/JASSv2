...
namespace JASS
	{
	/*
		COMPRESS_INTEGER_SIMPLE_16_PACKED::SIMPLE16_SHIFT_TABLE
		-------------------------------------------------------
	...
	*/
	...
	const size_t compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::simple16_shift_table[] =
		{
	...
	/*
		COMPRESS_INTEGER_SIMPLE_16_PACKED::INTS_PACKED_TABLE
		----------------------------------------------------
		Number of integers packed into a word, given its mask type
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	const size_t  compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::ints_packed_table[] =
		{
		28, 21, 21, 21, 14, 9, 8, 7, 6, 6, 5, 5, 4, 3, 2, 1
		};

	/*
		COMPRESS_INTEGER_SIMPLE_16_PACKED::CAN_PACK_TABLE
		-------------------------------------------------
		Bitmask map for valid masks at an offset (column) for some num_bits_needed (row).
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	const size_t  compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::can_pack_table[] =
		{
	...
	/*
		COMPRESS_INTEGER_SIMPLE_16_PACKED::INVALID_MASKS_FOR_OFFSET
		-----------------------------------------------------------
		We AND out masks for offsets where we don't know if we can fully pack for that offset
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	const size_t  compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::invalid_masks_for_offset[] =
		{
	...
	/*
		COMPRESS_INTEGER_SIMPLE_16_PACKED::ROW_FOR_BITS_NEEDED
		------------------------------------------------------
		Translates the 'bits_needed' to the appropriate 'row' offset for use with can_pack table.
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	const size_t  compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::row_for_bits_needed[] =
		{
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	size_t compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::encode(void *destination, size_t destination_length, const document_id::integer *source, size_t source_integers)
		{
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	void compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::decode(document_id::integer *destination, size_t destination_integers, const void *source, size_t source_length)
		{
	...
	*/
	template <typename ACCUMULATOR_TYPE, size_t MAX_DOCUMENTS, size_t MAX_TOP_K>
	void compress_integer_simple_16_packed<ACCUMULATOR_TYPE, MAX_DOCUMENTS, MAX_TOP_K>::unittest(void)
		{
		...
		*/
		...
		compress_integer_simple_16_packed compressor;
