...
*/
template <typename T, typename _Compare>
void ANT_heap<T, _Compare>::min_update(T key)
{
...
*/
template <typename T, typename _Compare>
void ANT_heap<T, _Compare>::text_render(long long i)
{
#ifdef NEVER
	printf("i: %lld, ", i);
...
*/
template <typename T, typename _Compare>
void ANT_heap<T, _Compare>::min_heapify(long long pos)
{
...
*/
template <typename T, typename _Compare>
void ANT_heap<T, _Compare>::build_min_heap()
{
...
*/
template <typename T, typename _Compare>
void ANT_heap<T, _Compare>::min_heapsort()
{
build_min_heap();
