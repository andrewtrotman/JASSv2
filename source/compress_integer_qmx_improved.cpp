...
namespace JASS
	...
	static uint32_t second_compress_buffer_ex[100000];
	static uint32_t *second_compress_buffer = (uint32_t *)(((uint8_t *)second_compress_buffer_ex) + 1);

	static uint32_t second_decompress_buffer_ex[100000];
	static uint32_t *second_decompress_buffer = (uint32_t *)(((uint8_t *)second_decompress_buffer_ex) + 1);
	...
	*/
	void check(uint32_t *sequence, uint32_t sequence_length)
		...
		uint64_t buffer_size = sizeof(second_compress_buffer);
		uint32_t pos;
		uint32_t fail;
		...
		buffer_size = compressor.encode(second_compress_buffer, buffer_size, sequence, sequence_length);
		...
		compressor.decode((uint32_t *)second_decompress_buffer, sequence_length, second_compress_buffer, buffer_size);
