...
namespace JASS
	...
	*/
	...
	/*
		...
		--------------------------------------------
	*/
	void compress_integer_bitpack_64::unittest_one(const std::vector<uint32_t> &sequence)
		{
		compress_integer_bitpack_64 compressor;
	...
	/*
		...
		----------------------------------------
	*/
	void compress_integer_bitpack_64::unittest(void)
		{
