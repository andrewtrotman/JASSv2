...
namespace JASS
	...
	*/
	...
	/*
		...
		---------------------------------------------------
	*/
	void compress_integer_bitpack_32_reduced::unittest_one(const std::vector<uint32_t> &sequence)
		{
		compress_integer_bitpack_32_reduced compressor;
	...
	/*
		...
		-----------------------------------------------
	*/
	void compress_integer_bitpack_32_reduced::unittest(void)
		{
