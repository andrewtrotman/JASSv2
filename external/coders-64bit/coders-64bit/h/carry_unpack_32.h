...
/* This code is automatically generated by:
          ./create_carry_unpack_32 32
   Do not change! 
   -------------------------- */


#ifndef _UNPACK_CARRY_32_H_
#define _UNPACK_CARRY_32_H_
#if _BYTES_PER_WORD == 4


#define CARRY_UNPACK_32(p) {            \
  switch(__wbits) {                         \
  case 1:                                      \
  ...
  case 7:                                      \
    ...
    p += 4;              \
    __wbits= __pc32[(__wbits<<2)+((*__wpos++>>28) & __mask[2])];  \
    selinprev= 1; \
    break;                                        \
  case 8:                                      \
  ...
  case 9:                                      \
    ...
    p += 3;              \
    __wbits= __pc32[(__wbits<<2)+((*__wpos++>>27) & __mask[2])];  \
    selinprev= 1; \
    break;                                        \
  case 10:                                      \
    ...
    break;                                        \
  case 14:                                      \
    p[0]= ( *__wpos & __mask[14] ) + 1;       \
    p[1]= ( (*__wpos >> 14) & __mask[14] ) + 1;       \
    p += 2;              \
    __wbits= __pc32[(__wbits<<2)+((*__wpos++>>28) & __mask[2])];  \
    selinprev= 1; \
    break;                                        \
